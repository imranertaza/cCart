(function($){$.fn.starRating=function(setup){let settings=$.extend(!0,{wrapperClasses:'',starIconEmpty:'fa-regular fa-star',starIconFull:'fa-solid fa-star',starColorEmpty:'lightgray',starColorFull:'#FFA439',starsSize:1.5,stars:5,showInfo:!0,titles:["Very bad","Bad","Medium","Good","Very good"],inputName:'rating'},setup||{});$(this).each(function(i,e){return init($(e))});function getTextColor(value){switch(!0){case value<(settings.stars/3):return'var(--bs-danger)';case value<(settings.stars/3*2):return'var(--bs-warning)';default:return'var(--bs-success)'}}
