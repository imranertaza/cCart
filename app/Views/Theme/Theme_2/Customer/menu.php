    ...
    <div class="container">
        ...
        <div class="elementToToggle d-none d-md-block">
            <div class="d-flex flex-column flex-md-row gap-2">
                ...
                <a href="<?php echo base_url('my-order'); ?>" class="btn btn-default border rounded-0 <?php echo ($menu_active == 'order') ? 'text-white bg-custom-color' : ''; ?>">My
                    order</a>
                ...
                <a href="<?php echo base_url('point-history'); ?>" class="btn btn-default border rounded-0 <?php echo ($menu_active == 'point_history') ? 'text-white bg-custom-color' : ''; ?>">Point History</a>
