                ...
                <div class="swiper bannerSlide">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <img data-sizes="auto" src="<?= commonImageViewUrl('uploads/slider', '', $sli_1, 'noimage.png', '837', '394');?>" alt="<?= getLebelByAltNameInThemeSettings('slider_1');?>" class="img-fluid w-100 slider-image-height" loading="lazy">
                        </div>
                        <?php $sli_2 = get_lebel_by_value_in_theme_settings('slider_2'); ?>
                        <div class="swiper-slide">
                            <img data-sizes="auto" src="<?= commonImageViewUrl('uploads/slider', '', $sli_2, 'noimage.png', '837', '394');?>" alt="<?= getLebelByAltNameInThemeSettings('slider_2');?>" class="img-fluid w-100 slider-image-height" loading="lazy">
                        </div>
                        <?php $sli_3 = get_lebel_by_value_in_theme_settings('slider_3'); ?>
                        <div class="swiper-slide">
                            <img data-sizes="auto" src="<?= commonImageViewUrl('uploads/slider', '', $sli_3, 'noimage.png', '837', '394');?>" alt="<?= getLebelByAltNameInThemeSettings('slider_3');?>" class="img-fluid w-100 slider-image-height" loading="lazy">
                        </div>
                    </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="product-grid d-flex align-items-stretch flex-column position-relative text-center">
                                                <div class="product-top">
                                                    <a href="<?php echo base_url('detail/' . $pro->product_id) ?>"><img data-sizes="auto" src="<?= productImageViewUrlNew( $pro->main_image, $pro->image, '100', '100');?>" alt="<?= $pro->alt_name;?>" class="img-fluid" loading="lazy"></a>
                            ...
                            <?php foreach ($specialPro as $pro) { ?>
                                <div class="row border-top mt-3 pt-1 pb-1" style="margin-left: -8px !important;margin-right: -8px !important;margin-top: -8px !important;">
                                    <div class="col-2 col-md-4 p-2">
                                        <a href="<?php echo base_url('detail/' . $pro->product_id) ?>"><img data-sizes="auto" src="<?= productImageViewUrlNew($pro->main_image, $pro->image, '71', '71');?>" alt="<?= $pro->alt_name;?>" class="img-fluid" loading="lazy"></a>
                                    </div>
                                        ...
                                        <div class="products  <?php echo ($key == '0') ? 'active' : ''; ?> p-md-4  text-center">
                                            ...
                                            <div class="text ic-pp-btn">
                                                ...
                                                <a href="#" class="bg-custom-color">
                                                    <svg class="mt-2 bg-custom-color" style="background-color:#000000  !important;" xmlns="http://www.w3.org/2000/svg" width="40" height="39" viewBox="0 0 40 39" fill="none">
