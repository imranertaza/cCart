                                ...
                                <div class="col border p-2">
                                    <div class="product-grid h-100 d-flex align-items-stretch flex-column position-relative">
                                        ...
                                        <div class="product-top">
                                            <img data-sizes="auto" src="<?= productImageViewUrl('uploads/products', $pro['product_id'], $pro['image'], 'noimage.png', '198', '198');?>" alt="<?=$pro['alt_name'];?>" class="img-fluid" loading="lazy">
