                ...
                <form action="<?php echo base_url('login_action')?>" method="post" class="sing-up" onsubmit="return onsubmitHendler()" >
                    ...
                    <div class="form-group">
                        <div class="input-group d-flex align-items-center bg-white border px-3 rounded-2 in_err">
                            <input class="form-control border-0" onsubmit="return onsubmitHendler()" id="email" name="email" type="email" placeholder="Email" value="<?php if(isset($_COOKIE['login_email_web'])){ echo $_COOKIE['login_email_web'];} ?>" required >
                    ...
                    <span class="text-danger mb-4 d-inline-block text-capitalize err mb-4" id="emailMass"></span>
                    <div class="form-group">
                        <div class="input-group d-flex align-items-center bg-white border px-3 rounded-2 in_err">
