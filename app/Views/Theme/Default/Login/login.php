...
<section class="main-container">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 text-center mb-4 mb-lg-0">
                <img src="<?php echo base_url()?>/assets/theme_1/img/sing-up.png" alt="Sing In" class="img-fluid">
            </div>
                ...
                <form action="<?php echo base_url('login_action')?>" method="post" class="sing-up" onsubmit="return onsubmitHendler()" >
                    ...
                    <div class="form-group">
                        <div class="input-group d-flex align-items-center bg-white border px-3 rounded-2 in_err">
                            <input class="form-control border-0" onsubmit="return onsubmitHendler()" id="email" name="email" type="email" placeholder="Email" value="<?php if (isset($_COOKIE['login_email_web'])) {
    ...
    echo 'checked';
                    ...
                    <div class="mt-3 text-center">
                        ...
                        <p class="mt-3"><a href="<?php echo base_url('register')?>" class="btn w-100 bg-black px-5 py-2 fs-5 text-white fw-semibold">Create an account</a></p>
                    </div>
                </form>
            </div>
        </div>
