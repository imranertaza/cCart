    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 text-center mb-4 mb-lg-0">
                <img src="<?php echo base_url()?>/assets/theme_1/img/sing-up.png" alt="Sing Up" class="img-fluid">
            </div>
            <div class="col-lg-6">
...
<!--                    <p class="text-center fs-4 my-3 text-gray">or</p>-->
                    <div class="mt-3 text-center">
                        ...
                        <p class="mt-3"><a href="<?php echo base_url('login') ?>" class="btn bg-black w-100 px-5 py-2 fs-5 text-white fw-semibold">Sign In</a></p>
                    </div>
                </form>
            </div>
        </div>
