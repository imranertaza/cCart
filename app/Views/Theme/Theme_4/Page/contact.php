...
<section class="main-container margin-t-b my-0">
    <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <a href="tel:+8801851670403" class="text-black">+8801851670403</a><br>
                            <a href="tel:+8801928174380" class="text-black">+8801928174380</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 mb-5 mb-lg-0">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="mailto:finerlabels@gmail.com" class="text-black">finerlabels@gmail.com</a>
                    </div>
                </div>
            </div>
        </div>
