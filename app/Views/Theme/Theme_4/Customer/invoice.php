                                ...
                                <tr>
                                    <td width="700" class="d-flex">
                                        <div class="img-table" >
                                            ...
                                            <img data-sizes="auto" src="<?= productImageViewUrl('uploads/products', $item->product_id, $product->image, 'noimage.png', '82', '82');?>" alt="<?= $product->alt_name;?>" class="img-fluid" loading="lazy">
