    ...
    <div class="container">
        ...
        ?>
                    ...
                    <p class="mb-4"><label class="btn bg-custom-color text-white w-100 rounded-0 "><input
                            ...
                            <img src="<?php echo base_url('svg/pencilIcon.svg')?>" alt="date">

                            Product shipping address elsewhere?

                            <img src="<?php echo base_url('svg/leftArowIcon.svg')?>" alt="date">
                        ...
                        <div class="list-item d-flex gap-2 mb-2">
                            <div class="d-flex gap-2 bg-gray p-2 rounded-2 pro-bg-check">
                                <?php
                                    ...
                                    ?>
                                <img data-sizes="auto" src="<?= productImageViewUrl('uploads/products', $val['id'], $img, 'noimage.png', '100', '100');?>" class="img-fluid" alt="<?= $alt_name?>" loading="lazy">
                                <div>
