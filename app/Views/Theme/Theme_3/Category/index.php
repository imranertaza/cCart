                    ...
                    <div class="top-bar border">
                        <div class="row">
                            <div class="col-3 col-md-3">
                                <a href="javascript:void(0)" onclick="viewStyle('gird')" id="gird-btn" class="d-inline-block border p-2 active-view"><img src="<?php echo base_url('svg/girdIcon.svg')?>" alt="date"></a>
                                <a href="javascript:void(0)" onclick="viewStyle('list')" id="list-btn" class="d-inline-block border p-2"><img src="<?php echo base_url('svg/listIcon.svg')?>" alt="date"></a>
                            </div>
