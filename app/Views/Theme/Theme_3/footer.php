...
const error = (selector, message) => {
    passwordMass = get(selector);
    passwordMass.innerHTML = message;
}
...
const onsubmitHendler = () => {
    ...
    const email = document.getElementById("email"),
        ...
        logEamilParent = document.querySelector("#logEamilParent"),
        logPasswordParent = document.querySelector("#logPasswordParent");
...
//     const payment_address_2 = get("#payment_address_2");
//     console.log(fname1)
// // console.log([fname1,lname1,email,payment_phone,stateView,payment_postcode,payment_address_1,payment_address_2]);
// return false;
//     let mailformat = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/;
//     if (fname1.value === "") {
//         fname1.classList.add("border-danger");
