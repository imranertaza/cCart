...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo base_url('admin/zone_rate_update_action')?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6">
...
foreach ($allRateOt as $rateOt) { ?>
                        ...
                        <div class="col-md-12 text-center">
                            ...
                            <a href="<?php echo base_url('admin/shipping')?>" class="btn btn-danger" >Back</a>
                        </div>
                    </div>
                </form>
            </div>
