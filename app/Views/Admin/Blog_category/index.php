...
foreach ($category as $val) {
    ...
    $parCat   = (!empty($val->parent_id)) ? get_data_by_id('category_name', 'cc_category', 'cat_id', $val->parent_id) . '-> ' : ''; ?>
                            <tr>
                                ...
                                <td>
                                    <img data-sizes="auto" src="<?= commonImageViewUrl('uploads/blog_category', '', $val->image, 'noimage.png', '166', '208'); ?>" alt="<?= $val->alt_name; ?>" class="width-80" loading="lazy">
                                </td>
                                ...
                                <td width="180">
                                    <a href="<?php echo base_url('admin/blog_category_update/' . $val->cat_id); ?>" class="btn btn-primary btn-xs"><i class="fas fa-edit"></i> Update</a>
