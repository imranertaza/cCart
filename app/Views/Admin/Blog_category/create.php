...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo base_url('admin/blog_category_create_action') ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <div class="row">
...
foreach ($icons as $valic) { ?>
                            ...
                            <a href="<?php echo base_url('admin/blog_category') ?>" class="btn btn-danger">Back</a>
                        </div>
