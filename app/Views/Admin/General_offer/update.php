...
<?= $this->section('content') ?>
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo base_url('admin/general_offer_update_action')?>" method="post" enctype="multipart/form-data">
                        <div class="row">
    ...
    if (!empty($val->product_id)) { ?>
                                ...
                                <a href="<?php echo base_url('admin/general_offer')?>" class="btn btn-danger" >Back</a>
                            </div>
                            <div class="col-md-6">
                                <h2>Get</h2>
                                <div class="form-group 	">
