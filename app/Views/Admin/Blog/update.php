                ...
                <form action="<?php echo base_url('admin/blog_update_action')?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <img data-sizes="auto" src="<?= commonImageViewUrl('uploads/blog', $blog->blog_id, $blog->image, 'noimage.png', '160', '150');?>" alt="<?= $blog->alt_name;?>" class="img-fluid" loading="lazy"><br>
                                <label>Image </label>
                                ...
                                <div class="row" id="reloadImg">
                                    <?php foreach ($crassulaImage as $img) { ?>
                                        <div class="col-md-4 position-relative">
                                            <img data-sizes="auto" src="<?= commonImageViewUrl('uploads/blog', $blog->blog_id . '/' . $img->blog_crassula_image_id, $img->image, 'noimage.png', '160', '150');?>" alt="<?= $img->alt_name;?>" class="img-fluid mt-1" loading="lazy">
