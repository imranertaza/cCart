            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo base_url('admin/admin_dashboard') ?>">Home</a></li>
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="optionForm" action="<?php echo base_url('admin/bulk_multi_attribute_action') ?>" method="post">
