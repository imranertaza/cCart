                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <a href="<?= base_url('admin/products') ?>" class="btn btn-danger btn-xs float-right mr-2 " >Back</a>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php foreach ($product as $key => $val) { ?>
                                <tr id="update_<?php echo $val->product_id?>">
                                    ...
                                    <td class="colum_image row_show "> <img data-sizes="auto" src="<?= productImageViewUrlNew($val->main_image, $val->image, '50', '50');?>" alt="<?= $val->alt_name;?>" class="img-fluid" loading="lazy"></td>
