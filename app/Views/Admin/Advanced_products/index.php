                        ...
                        ?>
                            <tr>
                                ...
                                <td class="colum_name row_show ">
                                    <p onclick="updateFunction('<?php echo $val->product_id; ?>','name','<?php echo $val->name; ?>','view_name_<?php echo $j++; ?>','bulkForm_name_<?php echo $val->product_id; ?>')">
                                ...
                                <td class="colum_model row_show ">
                                    <p onclick="updateFunction('<?php echo $val->product_id; ?>', 'model', '<?php echo $val->model; ?>', 'view_model_<?php echo $ml++; ?>','bulkForm_model_<?php echo $val->product_id; ?>')">
