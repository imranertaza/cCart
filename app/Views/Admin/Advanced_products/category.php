...
<form id="categoryForm" action="<?php echo base_url('admin/bulk_category_update') ?>" data-row="update_<?php echo $product_id;?>" method="post">
        ...
        <div class="form-group category">
            ...
            <select class="select2bs4" name="categorys[]" multiple="multiple" data-placeholder="Select a State" style="width: 100%;" required>
                <?php foreach ($prodCat as $key => $cat) { ?>
                    ...
                    }?> ><?php display_category_with_parent($cat->prod_cat_id);?></option>
                <?php } ?>
            </select>
