...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo base_url('admin/geo_zone_update_action')?>" method="post" enctype="multipart/form-data">
                    <div class="row">
...
foreach ($geo_zone_detail as $val) {
    ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <a href="<?php echo base_url('admin/geo_zone')?>" class="btn btn-danger" >Back</a>
                        </div>
                    </div>
                </form>
            </div>
