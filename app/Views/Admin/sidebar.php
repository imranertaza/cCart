    ...
    if ($menuAccessPur == true) {
        ?>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <?php echo add_main_based_menu_with_permission('General Offer', base_url('admin/general_offer'), $adRoleId, 'fa-circle', 'General_offer'); ?>
                        <?php echo add_main_based_menu_with_permission('Zone Based Offer', base_url('admin/zone_based_offer'), $adRoleId, 'fa-circle', 'General_offer'); ?>
                    </ul>
                </li>
    ...
    if ($menuAccessPur == true) { ?>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <?php echo add_main_based_menu_with_permission('Geo Zone', base_url('admin/geo_zone'), $adRoleId, 'fa-circle', 'Geo_zone'); ?>
